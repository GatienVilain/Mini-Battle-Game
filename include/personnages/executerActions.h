...
namespace personnages
{
    ...
    void executerActionsHeros(
        std::vector<outils::Choix> actions,
        std::vector<personnages::Hero*>& heros,
        std::vector<personnages::Monstre*>& monstres
    );
